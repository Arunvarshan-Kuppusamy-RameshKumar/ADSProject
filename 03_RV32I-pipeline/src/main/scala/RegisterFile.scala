...
//ToDo: Add your implementation according to the specification above here 
    ...
    io.resp_1.data := Mux(io.req_1.addr === 0.U, 0.U, registers(io.req_1.addr))  // Read port 1: if address is x0, return 0; otherwise return selected register value
    io.resp_2.data := Mux(io.req_2.addr === 0.U, 0.U, registers(io.req_2.addr))  // Read port 2: if address is x0, return 0; otherwise return selected register value
